...
def simAuction(dn, ds, debug):
    ...
    return highmarket, lowmarket

dn = [4967,-2.3]
ds = [11713, -2.34]
highmarket, lowmarket = simAuction(dn, ds, 1)
...
print northmarket.clearPrice, southmarket.clearPrice
